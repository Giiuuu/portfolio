...
const projectsData = {
    ...
    'slr': {
        title: "Android CRUD Application",
        img: "Androstud.png",
        content: "<p>A foundational Android application developed to demonstrate core mobile development concepts. The project focuses on implementing full CRUD (Create, Read, Update, Delete) operations, utilizing a local database to manage and persist data efficiently within the app.</p>",
        documentation: `<h3>Project Details</h3>
                        <ul style="margin-top: 15px; margin-left: 20px; color: var(--text-muted);">
                            <li><strong>Objective:</strong> Develop a functional Android app demonstrating local data management through CRUD operations.</li>
                            <li><strong>Tech Stack:</strong> Java/Kotlin, Android Studio, SQLite/Room Database, XML.</li>
                            <li><strong>Key Features:</strong> Intuitive user interface for data entry, dynamic Recycler View for data display, and persistent local storage.</li>
                        </ul>`,
